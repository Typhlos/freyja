...
| arch                    | No              | String       | None                               | Specify the architecture of your VM. Requires the installation of the corresponding qemu package. For instance, `qemu-system-aarch64` for `aarch64` aka `arm64`                         |
...
| cpu                     | No              | String       | None                               | Specify the CPU model you want to emulate. See `qemu-system-$ARCH -cpu help` for supported cpu                                                                          |
